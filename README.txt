...
create_matrix.js : gives each position all the possible notes that could possible go there
                    based on some rules defined by the user
create_constraints.js : the logic to take user defined rules and convert them into constraints
                        to be tested in the solver (untested, and incomplete)
